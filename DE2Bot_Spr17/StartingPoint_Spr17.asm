...
WaitForUser:
    ...
    LOAD   VolDown          ; load lower word of volume down
    STORE  RemoteCheck      ; store in RemoteCheck (needed for WaitForRemote)

;***************************************************************
;* Main code
;***************************************************************
Main:
    CALL   WaitForRemote    ; wait for volume down
...
;*******************************************************************************
; MoveForward: Moves forward by amount stored in Distance
;*******************************************************************************
MoveForward:
    IN THETA
    STORE DTheta
...
; Written by Jeremy Carter.  No licence or copyright applied.
;*******************************************************************************
WaitForRemote:
    IN     IR_LO            ; get the low word
